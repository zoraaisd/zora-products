...
const OrbiLeadsPage = ({ onBack, onHome, onAbout, onProducts, onContact, onDocumentation, onBlog, onFAQ, onPrivacy, onTerms, onCookie }: Props) => {
  useLayoutEffect(() => {
