...
const TelecomBotPage = ({ onBack, onHome, onAbout, onProducts, onContact, onDocumentation, onBlog, onFAQ, onPrivacy, onTerms, onCookie }: Props) => {
  useEffect(() => {
    window.scrollTo(0, 0);
